...
This guide explains how to install and use this dotfiles repository on a new machine.
...
This repository uses `chezmoi`'s templating engine to apply platform-specific configurations for macOS, Debian/Ubuntu, and WSL.

The installation script will automatically detect your operating system and apply the correct configuration.
